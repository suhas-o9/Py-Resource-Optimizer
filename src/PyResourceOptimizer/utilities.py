...
def get_inputs():
    ...
    Cloud = st.radio(
        ...
        horizontal=True,
        index=1,
        help="Find out from Ops which Cloud your Tenant/Hadoop Cluster is hosted on",
    )
    ...
    presliced_flag = st.checkbox(
        "Data Pre-Sliced?",
        help="Big Data tables are already partitioned, for example on HDFS",
    )
